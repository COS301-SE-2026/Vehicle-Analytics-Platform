    ...
    if(sql.includes('SELECT * FROM driver_daily_safety_scores WHERE score_date = $1')){
      ...
      return Promise.resolve({
        ...
        rows: [
          ...
          {vehicle_id: 'V001', score_date: '2025-01-01', safety_score: 85, harsh_brakes: 2, harsh_accelerations: 1, harsh_cornering: 0, crashes: 0, total_events: 3, classification: 'Good' },
