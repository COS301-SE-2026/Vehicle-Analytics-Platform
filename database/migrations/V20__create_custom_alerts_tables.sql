-- fleet_group_id references fleet_group table created in 
-- V19, a temp stub, which will be deleted onces 
-- the real groupings migrations lands, confirm tabel/column names still match here 
...
CREATE INDEX IF NOT EXIST idx_triggered_alerts_rule 
    ON triggered_alerts (rule_id);

CREATE INDEX IF NOT EXIST idx_triggered_alerts_vehicle
    ON triggered_alerts (vehicle_id);

CREATE INDEX IF NOT EXIST idx_trigger_alerts_time 
