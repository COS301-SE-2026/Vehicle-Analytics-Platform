-- Restores evaluate_safety_score_drop_rules to its V40 state (5-minute
-- debounce). No DROP here since the function is shared with the live
-- trigger by name — restoring its body is the revert.
