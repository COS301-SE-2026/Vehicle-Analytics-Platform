...
describe('CategoryList', () => {
  ...
  test('renders externally supplied article and calls onArticleShown once', async () => {
    const categories = buildCategories();
    ...
    // Use findByTestId or waitFor to allow queueMicrotask to settle
    const view = await screen.findByTestId('article-view');
