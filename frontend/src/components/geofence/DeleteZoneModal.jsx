...
export default function DeleteZoneModal( {open, onOpenChange, zone, onConfrim}) {
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="bg-fleet-surface">
        ...
        <AlertDialogFooter className="flex flex-col gap-2 sm:flex-col">
          <AlertDialogAction
            className="text-white bg-fleet-blue hover:bg-fleet-blue/90"
            onClick={() => onConfirm?.(zone)}
          >
            Delete
          </AlertDialogAction>
          <AlertDialogCancel className="text-fleet-secondary">
            Cancel
          </AlertDialogCancel>
        </AlertDialogFooter>
      </AlertDialogContent>
