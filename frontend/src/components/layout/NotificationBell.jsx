...
export default function NotificationBell({ isOpen, onOpen, onClose }) {
  ...
  const drawer = (
    <>
      ...
      <div
        ...
        aria-hidden="true"
        className={cn(
          'fixed inset-0 bg-black/60 z-[9998] transition-opacity duration-200',
      ...
      <div
        ...
        className={cn(
          'fixed top-0 right-0 h-full w-full sm:w-[380px] bg-fleet-surface shadow-2xl z-[9999]',
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-2">
          {loading ? (
            <div className="text-sm text-fleet-secondary/70 py-6 text-center">Loading...</div>
                  ...
                  <li key={n.id}>
                    ...
                    >
                      <Icon
                        ...
                        className={cn(
                          'shrink-0 mt-0.5',
                          n.read ? 'text-fleet-secondary/60' : 'text-fleet-blue'
                        )}
                      />
                      <div className="flex-1 min-w-0">
                        <p className={cn(
                          'text-sm',
                          n.read ? 'text-fleet-secondary' : 'text-fleet-secondary font-medium'
                        )}>
                          {n.message}
                        </p>
                        {n.timestamp && (
  ...
  return (
    <>
      ...
      {/* Drawer + backdrop portal to document.body */}
