...
import { 
    ...
    Coins, TrendingDown, Zap, X, Clock
...
function EfficiencyBreakdownModal({ isOpen, onClose, avgEfficiency }) {
    ...
    <div key={road} className="flex items-center justify-between px-3 py-2 bg-white rounded-lg border border-gray-100">
                    ...
                    <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-200/50">
                        ...
                        <p className="text-xs font-medium text-emerald-600 uppercase tracking-[0.08em]">How It Is Calculated</p>
...
if (!data || data.trips.length === 0) {
    ...
    return (
        ...
        className="flex flex-col items-center justify-center min-h-[350px] text-center p-8 bg-gradient-to-b from-gray-50/50 to-white rounded-2xl border border-gray-100/80"
...
>
                ...
                <h4 className="text-xl font-semibold text-gray-800 mb-2">No Fuel Data Yet</h4>
                ...
                <div className="max-w-md space-y-4">
                    ...
                    <p className="text-sm text-gray-500 leading-relaxed">
                        Fuel efficiency data is calculated automatically after each completed trip using:
                    ...
                    <div className="grid grid-cols-1 gap-2 text-left">
                        ...
                        <div className="flex items-start gap-3 bg-white rounded-lg p-3 shadow-sm border border-gray-100">
                            ...
                            <div className="mt-0.5 w-2 h-2 rounded-full bg-emerald-500 flex-shrink-0"></div>

                            <div>

                                <span className="text-sm font-medium text-gray-700">Trip Data</span>

                                <p className="text-xs text-gray-400">Distance, speed, and GPS coordinates from completed trips</p>
                        ...
                        <div className="flex items-start gap-3 bg-white rounded-lg p-3 shadow-sm border border-gray-100">
                            ...
                            <div>
                                ...
                                <span className="text-sm font-medium text-gray-700">Road Classification</span>

                                <p className="text-xs text-gray-400">Road type data from OpenStreetMap for accurate calculations</p>
                        ...
                        <div className="flex items-start gap-3 bg-white rounded-lg p-3 shadow-sm border border-gray-100">
                            ...
                            <div>
                                ...
                                <span className="text-sm font-medium text-gray-700">Speed Adjustment</span>

                                <p className="text-xs text-gray-400">Optimal efficiency at 55-65 km/h, adjusted for driving behavior</p>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100">
                        ...
                        <p className="text-xs text-gray-400">
                            ...
                            Data typically appears within 24 hours of trip completion

                        </p>

                        <p className="text-xs text-gray-400 mt-1">

                            Tip: Complete more trips to generate fuel efficiency insights
